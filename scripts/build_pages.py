    ...
    <section class="theme-band">
      <div class="wrap">
        <div class="section-head">
          <p class="kicker">Research themes</p>
          <h2>One integrated discovery loop</h2>
        </div>
        <figure class="theme-figure">
          <img src="assets/img/research-themes.jpg" alt="Schematic of the lab's research themes: iPSC, developmental biology, functional genomics, multiomics, machine learning, and cardio-oncology" width="2048" height="1143" loading="lazy" decoding="async">
        </figure>
      </div>
    </section>
